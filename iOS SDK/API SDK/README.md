...
|------------------------------------------|----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|createUserToken                              |This method is used to authenticate the user from server.                                     |Create request object by using this model CreateTokenRequestModel <br>1. <b>token</b> - "<token_key>" <br> 2. <b>channel</b> - "<channel>" <br> 3. <b>referenceNumber</b> - "<reference_number>" <br> 4. <b>typeOfRequest</b> - "<type_of_request>".                                                                                                                                                                                                                                                                                         |
